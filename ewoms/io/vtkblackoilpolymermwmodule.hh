 ...
 */
#ifndef EWOMS_VTK_BLACK_OIL_POLYMER_MW_MODULE_HH
#define EWOMS_VTK_BLACK_OIL_POLYMER_MW_MODULE_HH
...
class VtkBlackOilPolymerMWModule : public BaseOutputModule<TypeTag>
{
